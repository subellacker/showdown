var BattleTooltips = (function () {
  ...
  BattleTooltips.prototype.showMoveTooltip = function (move, isZ) {
    ...
    // Check if there are more than one active Pok̩mon to check for multiple possible BPs.
    if (yourActive.length > 1) {
      ...
      // The trick is that we need to calculate it first for each Pok̩mon to see if it changes.
